"""Doorenbos §2.3 — node-sharing example loaded from PRL.

Two rules with logically identical C1/C2 and differing C3.
Expected matches: (B1,B2,B3) and (B1,B3,B4).
"""
...
_PRL = Path(__file__).parent / "prl" / "sharing.prl"
